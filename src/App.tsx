...
import './App.css'
import '../src/images/pink aura wallpaper made by 5ell.jpg'
...
function App() {
  ...
  return (
    <>
      <CenteredContainer className="centerContainer">
        <div className="app-container" >
        <InputGroup className="mb-3 input-group" style={{ width: '500px' }}>
            <Form.Control
